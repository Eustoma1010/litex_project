...
**Ảnh minh họa quá trình mô phỏng dạng sóng:**

![Waveform Full](images/waveform_full.png)
*Hình 1: Tổng quan dạng sóng toàn bộ quá trình boot.*

![Waveform Zoom](images/waveform_zoom.png)
*Hình 2: Dạng sóng được phóng to chi tiết quá trình CPU tương tác với các thanh ghi qua bus.*
...
**Tác giả chính:**
- Phan Phước Quốc Thiện - [thienphan370@gmail.com](mailto:thienphan370@gmail.com)
...
1. **LiteX Framework**: [https://github.com/enjoy-digital/litex](https://github.com/enjoy-digital/litex)
2. **LiteX Wiki & Documentation**: [https://github.com/enjoy-digital/litex/wiki](https://github.com/enjoy-digital/litex/wiki)
3. **VexRiscv CPU (SpinalHDL)**: [https://github.com/SpinalHDL/VexRiscv](https://github.com/SpinalHDL/VexRiscv)
4. **RISC-V ISA Specifications**: [https://riscv.org/technical/specifications/](https://riscv.org/technical/specifications/)
5. **Verilator (Verilog Simulator)**: [https://verilator.org/](https://verilator.org/)
6. **GtkWave Manual**: [https://gtkwave.sourceforge.net/](https://gtkwave.sourceforge.net/)
